 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === "connecting") {
                   console.log("📡CONNECTING TO MIRAGE -MD HOST.");
                }
                if (connection === 'open') {
...
app.listen(port, () => console.log(`MIRAGE-MD Server listening on port http://localhost:${port}!`));
