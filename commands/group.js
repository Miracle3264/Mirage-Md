...
cmd({
    ...
    async(Void, citel, text) => {
        ...
        await Void.sendMessage(`${citel.sender}`, {
            image: log0,
            caption: `*Group Name: Mirage-Support*\n*Group Link:* https://whatsapp.com/channel/0029VaghjWRHVvTh35lfZ817`,
        });
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            if (!citel.quoted.isBot) {
                ...
                if (!isBotAdmins) return citel.reply('I can\'t delete message without getting Admin Role.')
