...
cmd({
    ...
    async(Void, citel) => {
        let { data } = await axios.get('https://api.github.com/repos/M3264/Mirage-Md')
        let cap = `Hey ${citel.pushName}\n
*⭐ Total Stars:* ${data.stargazers_count} stars
*🍽️ Forks:* ${data.forks_count} forks
*🍁 Repo:* https://github.com/M3264/Mirage-Md
*Channel:* https://whatsapp.com/channel/0029VaghjWRHVvTh35lfZ817
*Contact:* https://whatsapp.com/channel/0029VaghjWRHVvTh35lfZ817
        let buttonMessaged = {
...
if(!isCreator) return citel.reply(tlang().owner);
let str="*All available themes in Mirage*"
str+=`1. MIRAGE\n2. ADAM\n3. AYANOKOJI\n4. EDITH\n5. FRIDAY\n6. GENOS\n7. GIDEON\n8. GOKU\n9. LUFFY\n10. NARUTO\n11. NEZUKO\n12. PARKER\n13. ZEROTWO\n14. Eren Jeager(Coming Soon)\n\n these are the themes of Mirage Userbot.\_Reply ${prefix}setvar THEME:ZEROTWO`
