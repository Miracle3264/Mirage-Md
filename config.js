...
global.botname = process.env.BOT_NAME || 'ᴹᶦʳᵃᵍᵉ',
...
global.caption = process.env.CAPTION || 'Generated with 🖤',
...
global.ALIVE_MESSAGE = process.env.ALIVE_MESSAGE || '`Hallo👋 Mirage-Md is Alive $ Active`',
